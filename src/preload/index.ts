...
const api = {
  ...
  getContactPhoto: (handle: string): Promise<string | null> => ipcRenderer.invoke('get-contact-photo', handle),
  getAllContactPhotos: (): Promise<Record<string, string>> => ipcRenderer.invoke('get-all-contact-photos'),
